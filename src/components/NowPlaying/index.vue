...
<style scoped="scoped">
	 .movie_body{ flex:1; overflow:auto;position: fixed;height: calc(100% - 146px); top:96px;left: 0px;width: 100%; -webkit-overflow-scrolling : touch;}
	.movie_body ul{ margin:0 12px; overflow: hidden;}
	.movie_body ul li.pulldown{margin-top: 0px;padding-bottom: 0px;}
